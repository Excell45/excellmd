...
global.sig = 'https://instagram.com/excell445' // ig
global.sgh = 'https://github.com/Excell45' // github
global.sgc = 'https://chat.whatsapp.com/gaada' // group whatsapp
global.sdc = 'https://www.discord.com'//discord
global.snh = 'https://youtube.com/@excellnotprobleml' // my youtube channel
global.sfb = 'https://www.facebook.com/' // facebook
global.syt = 'https://youtube.com/@excellnotproblem' // my youtube channel "kalau ada yt ke 2 tarok link nya disini"

/*============== PAYMENT ==============*/
global.pdana = 'Chat Owner Kak' //dana
global.povo = 'Chat Owner Kak' //ovo
global.pgopay = 'Chat Owner kak' //gopay
global.plinkaja = 'Chat Owner kak' //link aja
global.ppulsa = 'Chat Owner kK' //telkomsel
global.ppulsa2 = 'chat owner kak' // kalau ada kartu lain isi aja
global.psaweria = 'https://saweria.com/nvtz'

/*============== NOMOR ==============*/
global.nomorbot = '62895622225489'
global.nomorown = '62895622225489'
global.namebot = '𝙀𝙓𝘾𝙀𝙇𝙇𝘽𝙊𝙏'
global.nameown = '𝐄𝐗𝐂𝐄𝐋𝐋𝐃𝐄𝐕'

/*============== Github Thanks To ==============*/
global.namagithub = 'Excell45' // nama github lu
...
/*============== WATERMARK ==============*/
global.wm = '                「 𝐄𝐗𝐂𝐄𝐋𝐋𝐃𝐄𝐕 」' //Main Watermark
global.wm2 = '꒷︶꒷꒥꒷ ‧₊˚ ꒰ฅ˘𝙀𝙓𝘾𝙀𝙇𝙇𝘽𝙊𝙏 ˘ฅ ꒱ ‧₊˚꒷︶꒷꒥꒷'
global.wm3 = "⫹⫺ 𝐄𝐗𝐂𝐄𝐋𝐋𝐃𝐄𝐕"
global.botdate = `⫹⫺ DATE: ${week} ${date}\n⫹⫺ TIME: ${wktuwib}`
global.bottime = `T I M E : ${wktuwib}`
global.titlebot = `⫹⫺ WhatsApp Bot | By 𝐄𝐗𝐂𝐄𝐋𝐋𝐃𝐄𝐕`
global.packname = '☂︎ ᴄʀᴇᴀᴛᴇᴅ ʙʏ'
global.author = "𝐄𝐗𝐂𝐄𝐋𝐋𝐃𝐄𝐕 乂 𝙀𝙓𝘾𝙀𝙇𝙇𝘽𝙊𝙏𝙕"
